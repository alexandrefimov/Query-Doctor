...
Query Doctor contributors are expected to keep discussions professional,
specific, and safe for a project that may operate near sensitive production
systems.
...
Maintainers may edit, hide, or delete unsafe content; close issues or pull
requests; restrict participation; or move security-sensitive discussion to a
private channel. Security issues should follow [SECURITY.md](SECURITY.md).
