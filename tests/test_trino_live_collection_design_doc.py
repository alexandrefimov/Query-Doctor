...
def test_trino_live_collection_design_defines_source_phases_and_bounds():
    ...
    for required in (
        ...
        "allowed Trino web/CLI registry remains limited to compact preview surfaces",
