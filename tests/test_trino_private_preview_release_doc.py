...
def test_trino_private_preview_release_path_defines_demo_storyline():
    ...
    for required in (
        ...
        "stored compact diagnosis artifact is checked against the deterministic boundary-derived diagnosis",
