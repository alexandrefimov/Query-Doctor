...
def render_report_header(result: Any) -> str:
    return (
        ...
        "<div class=\"report-subtitle\">Saved validated report rendered from the local case directory.</div>"
        "<div class=\"query-line\">"
        f"<span>Query/case:</span><code>{html.escape(result.query_id)}</code>"
        f"<span>Case:</span><code>{html.escape(str(result.case_dir))}</code>"
        "</div></div></div>"
        ...
        "<span class=\"status-item\"><span class=\"dot gray\"></span>Model: <span class=\"badge gray\">qwen3-coder:30b</span></span>"
        "<span class=\"status-item\"><span class=\"dot\"></span>Rendered after validation</span>"
        "</div></section>"
    )
...
def render_report_metadata_card(result: Any, has_facts: bool) -> str:
    ...
    return (
        ...
        "<div class=\"meta-row\"><span>Model</span><strong>qwen3-coder:30b</strong></div>"
