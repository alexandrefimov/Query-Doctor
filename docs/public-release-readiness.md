...
- Public docs state current support honestly: Apache Impala only, current
  Cloudera Manager collection validated against the local CM 6.2.1 environment,
  and future engines/providers/Cluster Doctor as roadmap seams only.
