...
| Direct Impala daemon collection | `query_doctor/impala/`, `query_doctor/recent/`, `query_doctor/cli/collect_impala_profile.py` | Bounded Recent, Running, and one Known Query ID profile source; no Cloudera Manager events. |
