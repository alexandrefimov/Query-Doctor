...
RULES: tuple[Rule, ...] = (
    ...
    Rule(
        ...
        tests=(
            "python3 -m pytest -q tests/test_agent_preflight.py tests/test_check_active_docs.py tests/test_check_staged_public_safety.py tests/test_audit_public_docs.py tests/test_worktree_status.py",
            "python3 scripts/check_active_docs.py",
            "python3 scripts/audit_public_docs.py",
            "git diff --check",
        ),
