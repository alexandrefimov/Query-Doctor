...
def cardinality_mismatch_count(facts: str) -> int:
    from query_doctor_query_optimization_score import cardinality_mismatch_count as _count

    return _count(facts)


def fact_int(facts: str, label: str) -> int | None:
    from query_doctor_query_optimization_score import fact_int as _fact_int
