...
<p>Help covers current product workflows. Future engine and storage scope lives in the public roadmap and support matrix, while Apache Impala remains the production triage engine.</p>
</div>
</details>
</div>
</section>
...
<p>Help описывает текущие product workflows. Future engine и storage scope живут в roadmap и support matrix; production triage engine сейчас Apache Impala.</p>
</div>
</details>
</div>
</section>
